...
const blogs: Blog[] = [
  {
    ...
    category: 'Design',
    excerpt: 'Keep up with the latest trends, news, and ideas that shape the world.',
    image: '/images/Article1.png' //  Updated file name
  },
  {
    id: 2,
    title: 'Blog Post 2',
    ...
    image: '/images/Article2.png', // Updated file name
  },
  {
    id: 3,
    title: 'Blog Post 3',
    ...
    image: '/images/Article3.png', // Updated file name
  },
];
    ...
    <div>
      ...
      <div className="py-16  w-full flex items-center justify-center space-y-2 bg-[#f6f5ff]">
        <div className="w-[80%]   lg:w-[1177px]">
          <h1 className="text-4xl my-2 font-bold text-[#001F54]">Blog Page</h1>{' '}
          {/* Dark blue */}
